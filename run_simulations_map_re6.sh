...
recomb_map="/wynton/group/hernandez/guardado075/founder_1kg/recomb_map/hapmap_re6_chr${CHR}.txt"
output_prefix="/wynton/scratch/guardado075/king_hap_ibd/recomb_results/large_fam_${POP}_seed${SEED}_chr${CHR}_hapmap_re6"
